      ...
      {cards.map((card) => {
        ...
        return (
          <button
            ...
            disabled={!clickable}
            className={`
              relative overflow-hidden rounded-xl border bg-white p-4 text-left shadow-sm transition-all
          ...
          >
            ...
            {pendentes > 0 && card.key === 'total' && (
              <div className="mt-3 flex items-center gap-1.5 rounded-md bg-orange-50 px-2 py-1">
